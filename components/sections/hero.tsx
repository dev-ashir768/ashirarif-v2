    ...
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden pt-16 md:pt-24">
      ...
      <div className="container relative z-10 flex flex-col items-center text-center">
        <motion.div
          ...
          className="inline-flex items-center rounded-full border border-black/5 dark:border-white/10 bg-black/5 dark:bg-white/5 px-4 py-1.5 text-sm font-medium text-primary shadow-lg backdrop-blur-md mb-6 hover:bg-black/10 dark:hover:bg-white/10 transition-colors cursor-default"
        >
        ...
        >
          ...
          <span className="block text-base sm:text-3xl md:text-5xl font-light text-muted-foreground mt-2 md:mt-3">
            {personalData.role}
          </span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="max-w-xl text-base sm:text-lg text-muted-foreground mb-7 md:mb-10 leading-relaxed"
        >
        ...
        >
          <Button
            asChild
            size="lg"
            className="rounded-full h-11 px-8 text-sm bg-primary hover:bg-primary/90 hover:scale-105 transition-all duration-300 shadow-[0_0_20px_rgba(79,70,229,0.3)]"
          >
            <Link href="#contact">
        ...
        <motion.div
          ...
          className="mt-10 md:mt-14 flex gap-5 text-muted-foreground"
        >
          {[
            { href: "https://github.com/ashirarif", Icon: Github },
            { href: "https://linkedin.com/in/ashirarif", Icon: Linkedin },
            { href: `mailto:${personalData.email}`, Icon: Mail },
          ].map(({ href, Icon }) => (
            <a
              key={href}
              href={href}
              ...
              className="p-2 rounded-full hover:bg-primary/10 hover:text-primary transition-all duration-200 hover:scale-110"
            >
