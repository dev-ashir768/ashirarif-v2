  ...
  return (
    <section className="relative flex min-h-[calc(100vh-4.5rem)] md:min-h-screen flex-col items-center justify-center overflow-hidden pt-16 md:pt-24">
      ...
      <div className="container relative z-10 flex flex-col items-center text-center">
        {/* Logo */}
        <div className="mb-4 md:mb-6 hero-fade-in" style={{ animationDelay: "0ms" }}>
        ...
        {/* Name + Role — LCP element, no opacity:0 */}
        <div className="mb-3 md:mb-5 hero-slide-up" style={{ animationDelay: "80ms" }}>
        ...
        {/* Headline */}
        <p
          className="max-w-lg text-base sm:text-lg text-muted-foreground mb-7 md:mb-10 leading-relaxed hero-slide-up"
        ...
        {/* CTA */}
        <div
          className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto hero-slide-up"
        ...
        {/* Social Links */}
        <div
          className="mt-8 md:mt-12 flex gap-4 text-muted-foreground hero-fade-in"
